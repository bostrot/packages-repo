...
$packageArgs = @{
  ...
  url        = 'https://downloads.remarkable.com/desktop/production/win/reMarkable-3.0.4.675-win32.exe' # download url, HTTPS preferred

  #file         = $fileLocation

  softwareName  = 'reMarkable*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  ...
  silentArgs   = '--accept-licenses --default-answer --confirm-command install'           # QT Installer Framework (QIFW)
